  ...
  return (
    <div className="m-auto bg-qwhite h-screen">
      ...
      <div className='bg-qPurple/20 p-8'> 
        <h1 className='text-center text-4xl uppercase font-extrabold text-qPurple'>Wellness Questionnaire</h1> 
      </div>
      {showScore ? (
        <div className='h-screen text-center bg-qPurple text-qWhite pt-12 border-y-2 border-qYellow'>
          <h2 className="text-3xl font-semibold">Thank YOU for taking this Quiz!</h2>
          
          <h2 className="text-3xl font-semibold text-center text-qYellow mt-4">You scored {score} out of {questions.length}</h2>
      ...
      <div className="flex flex-col w-[40%] my-4 px-5 mx-auto  justify-center items-center shadow-2xl border-2 border-qPurple/50 rounded-lg">
        ...
        <div className="flex justify-between w-full mt-4 text-white pb-4">
          <button className="w-[49%] py-3 bg-qPurple rounded-md text-qWhite  font-bold hover:text-qYellow" onClick={handlePrevious}>Previous</button>
